...
const ColorPicker = (props) => {
    ...
    console.log(chroma("#FFFFFF").darken().hex())
    return (
        <ColorPickerContext.Provider value={{selected,setSelected,primary,setPrimary,secondary,setSecondary,activeColorType,setActiveColorType}}>
                <Accordion expanded={expanded} onChange={()=>setExpanded(!expanded)}>
                    <AccordionSummary
                        ...
                        id="panel1a-header"
                        >
                        <Typography className={classes.heading}>Form Colors</Typography>
                        <div style={{height:"32px",width:"32px",borderRadius:"4px",backgroundColor:primary}}>

                        </div>
                        <div style={{height:"32px",width:"32px",borderRadius:"4px",backgroundColor:secondary}}>
                            
                        </div>
                    </AccordionSummary>
                    <AccordionDetails>
                        <div style={{display:"flex",flexDirection:"column"}}>
                            <Button onClick={handleSaveColors} style={{marginBottom:"10px"}} variant={"outlined"}>Save Color Options</Button>
